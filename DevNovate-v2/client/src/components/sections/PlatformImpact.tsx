  ...
  const statCards = [
    {
      ...
      icon: <Laptop className="w-8 h-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500" />,
    ...
    },
    {
      ...
      icon: <Rocket className="w-8 h-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500" />,
    ...
    },
    {
      ...
      icon: <Building className="w-8 h-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500" />,
    ...
    },
    {
      ...
      icon: <Lightbulb className="w-8 h-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500" />,
