  ...
  return (
    <header 
      className={`fixed w-full top-0 z-50 transition-all duration-300 ${
        isScrolled 
          ? 'py-3 bg-white/80 backdrop-blur-xl shadow-sm border-b border-gray-100' 
          : 'py-4 bg-white'
      }`}
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2 relative group">
              <div className="flex items-center justify-center w-10 h-10 bg-primary/10 rounded-xl relative overflow-hidden group-hover:bg-primary/20 transition-colors duration-300">
              ...
              {/* Beta badge */}
              <div className="absolute -top-2 -right-12 bg-gradient-to-r from-amber-500 to-pink-500 text-white text-[10px] px-1.5 py-0.5 rounded-full font-medium tracking-wide">
                BETA
              </div>
            </Link>
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              className="lg:hidden mt-4 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden"
              initial="hidden"
              animate="visible"
              exit="exit"
            ...
            >
              <div className="p-4">
                <div className="space-y-6">
                  <div>
                    <Link to="/challenges">
                      <span className="block px-3 py-2 text-gray-700 hover:text-gray-900 font-medium transition-colors hover:bg-gray-50 rounded-md">
                        Challenges
                      </span>
                    </Link>
                  </div>
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <Button 
                    className="w-full bg-purple-600 hover:bg-purple-700 text-white shadow-sm hover:shadow"
                  >
                    Join with 1-Click
                  </Button>
                </div>
